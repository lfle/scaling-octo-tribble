...
REAL * 8 :: AB, OA, BC, OC, PSS_NGLR, MG_PNT, NGLR_STP
REAL * 8, DIMENSION(0:1000) :: L, M, N, O, P, Q, LF, BT, GM_NM, GM_DN, GM, &
...
WRITE (unit = 10, fmt = "(F8.3,',',f8.3,',',f8.3,',',F10.4,',',f10.4,',',f10.4,',',f10.4,',',f10.4,',',F10.4,',',F10.4)") & 
